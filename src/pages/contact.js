            ...
            <div id='contact_container'>
                ...
                <form id="contact_form" action="/College_Gigs/C_Gigs_Home.php" method="post">
                    <div className="contact_form_item">
                        ...
                        <input type="email" id="email" name="email" className="contact_input" required/>
                    </div>

                    <div className="contact_form_item">
                        <label htmlFor="subject">Subject</label>
                        <input type="text" id="subject" name="subject" className="contact_input"/>
                    </div>

                    <div className="contact_form_item">
                        <label htmlFor="desc"><i className="fa fa-commenting-o"></i> Description</label>
                        <textarea id="desc" name="desc" className="desc contact_input"
